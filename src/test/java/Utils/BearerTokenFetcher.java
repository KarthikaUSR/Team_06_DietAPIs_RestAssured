...
public class BearerTokenFetcher extends RestUtils {
    ...
    static {
        try {
            ...
            FileInputStream in = new FileInputStream("/Users/91948/git/Team_06_DietAPIs_RestAssured/src/test/resources/config.properties");
            properties.load(in);
            in.close();
        } catch (IOException e) {
            e.printStackTrace();
...
//        return token;
    ...
    private static void setTokenInGlobalConfig(String token) {
        try {
            ...
            FileOutputStream out = new FileOutputStream("/Users/91948/git/Team_06_DietAPIs_RestAssured/src/test/resources/config.properties");
